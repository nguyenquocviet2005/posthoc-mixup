...
parser.add_argument('--data', default='cifar10', type=str, help='Dataset name to use [cifar10, cifar100, pathmnist, alzheimer, tuberculosis, sars_cov_2_ct_scan, chest_ct_scan, chest_xray, mri_tumor, skin_cancer_isic]')
...
def main():
    ...
    elif args.data in ['skin_cancer_isic', 'chest_xray', 'tuberculosis', 'sars_cov_2_ct_scan']:
        num_class = 2
        args.classnumber = 2
